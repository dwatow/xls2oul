========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : xls2oul
========================================================================


AppWizard has created this xls2oul application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your xls2oul application.
...
res\xls2oul.ico
    ...
    icon is included by the main resource file xls2oul.rc.
...
xls2oulDlg.h, xls2oulDlg.cpp - the dialog
    These files contain your CXls2oulDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in xls2oul.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CXls2oulDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named xls2oul.pch and a precompiled types file named StdAfx.obj.
